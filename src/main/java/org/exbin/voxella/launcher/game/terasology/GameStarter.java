...
import org.exbin.voxella.launcher.game.terasology.util.Platform;
...
class GameStarter implements Callable<Process> {
    ...
    GameStarter(Installation installation, Path gameDataDirectory, JavaHeapSize heapMin, JavaHeapSize heapMax,
        ...
        processParameters.add("-DlogOverrideLevel=" + logLevel.getName());
    ...
    public Process call() throws IOException {
        logger.log(Level.INFO, "Starting game with: {0}", String.join(" ", processBuilder.command()));
